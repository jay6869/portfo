...
export const Route = createFileRoute("/projects")({
  head: () => ({
    meta: [
      { title: "Projects — Janith Godage" },
      { name: "description", content: "Offensive security tooling, blue-team platforms, and research projects." },
      { property: "og:title", content: "Projects — Janith Godage" },
