...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Cybersecurity undergraduate building offensive security tooling — breaking things ethically, then engineering the defenses." },
      { property: "og:title", content: "Janith Godage — Offensive Security & Tooling" },
