...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      { title: "Contact — Janith Godage" },
      { name: "description", content: "Reach me by email, GitHub, LinkedIn, or the form on this page. PGP available on request." },
      { property: "og:title", content: "Contact — Janith Godage" },
