...
// Undocumented — intentionally absent from MANUAL/COMPLETIONS/CHIPS.
const SUJEE_ART = String.raw` ___  ___  ___  ___          ___       ________  ________  ________
|\  \|\  \|\  \|\  \        |\  \     |\   __  \|\   __  \|\   __  \
\ \  \\\  \ \  \ \  \       \ \  \    \ \  \|\  \ \  \|\ /\ \  \|\ /_
 \ \   __  \ \  \ \  \       \ \  \    \ \  \\\  \ \   __  \ \   __  \
  \ \  \ \  \ \  \ \  \       \ \  \____\ \  \\\  \ \  \|\  \ \  \|\  \
...
export function InteractiveTerminal() {
  ...
  const exec = (raw: string): Line[] | "clear" => {
    ...
    if (cmd === "sujee") return out(SUJEE_ART, "accent", true);
